...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative pt-[250px] px-[200px] pb-[80px] flex h-[0px] flex-col items-center justify-center overflow-hidden bg-slate-950 w-full z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-purple-500 text-white [--conic-position:from_290deg_at_center_top] pt-6"
        >
        ...
        <div className="absolute inset-auto z-50 h-10 w-[28rem] -translate-y-1/3 rounded-full bg-purple-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
