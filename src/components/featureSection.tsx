        ...
        <div className='bg-[#1d0828] p-14'>
            ...
            <div className='mt-12'>
                <div className='grid grid-cols-7 gap-4'>
                    <div className='col-start-2 col-span-3 h-64 bg-blue-800 rounded-lg'>
                    ...
                    <div className='h-64 col-start-2 col-span-2 bg-blue-800 rounded-lg'>
                        <div className='flex justify-center font-bold p-5'>
                    ...
                    <div className='col-start-4 col-span-3 h-64 bg-blue-800 rounded-lg'>
                        <div className='flex justify-center font-bold p-5'>
