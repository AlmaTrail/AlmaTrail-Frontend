    ...
    return (
        <div>
            <div className='flex flex-row p-8'>
                <Image src={IntroImage} className="w-1/2 h-2/3 sm:hidden" alt="intro_image" />
                <div className='flex flex-col mt-12 lg:w-5/12'>
                    <p className='text-3xl font-gilroy-bold text-[#1d0828] sm:text-center'>We Provide you the best platform to start</p>
                    <p className='mt-7 text-slate-500 text-sm font-gilroy-regular sm:text-center'>We offer you the best platform to make some side income while working you also got the satisfaction by helping the new dreamers
            ...
            <div className='flex flex-row sm:flex-col py-7 px-10 justify-center sm:items-center sm:gap-16 lg:gap-32'>
                <div className='w-52'>
