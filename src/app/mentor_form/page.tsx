...
import Page1 from "../../components/MentorForm/Page1";
import Page2 from "../../components/MentorForm/Page2";
import Page3 from "../../components/MentorForm/Page3";
import Page4 from "../../components/MentorForm/Page4";
import CustomStepper from "../../components/MentorForm/CustomStepper";
...
export default function Home() {
  ...
  return (
    <div className=" flex justify-center items-center h-screen bg-gray-200">
      <Card
        sx={{width: "100%", maxWidth: "800px", bgcolor: "background.paper", padding: 2,
        height: "550px", borderRadius: 2, boxShadow: 3, overflowY: "auto",}}
      >
        <CustomStepper
          steps={steps}
